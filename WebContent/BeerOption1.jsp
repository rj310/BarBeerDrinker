...
<html>
	...
	<%@ include file="Header.jsp" %>
		...
		<% try {
			...
			String str = "select bills.bar,sum(transactions.quantity) as TAS from bills inner join transactions on bills.bill_id=transactions.bill_id where transactions.item=  '"+nameofbeer+
							"' group by bills.bar order by TAS desc limit 5";
		...
		<table class="table table-striped">
		  <thead class="thead-dark">
		    <tr>
		      ...
		      <th style="text-align:center" scope="col">Bar Name</th>
